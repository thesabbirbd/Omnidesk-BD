...
export default function Sidebar() {
  return (
    <aside className="w-72 bg-[var(--bg-panel)] border-r border-[var(--border-color)] flex flex-col h-full overflow-hidden z-20 transition-all duration-300 select-none shrink-0">
      
      {/* Brand Header */}
      <div className="pt-6 pb-5 px-6 flex items-center gap-3.5 border-b border-[var(--border-color)]">
