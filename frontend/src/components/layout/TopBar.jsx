...
export default function TopBar({ onToggleSidebar = () => {} }) {
  ...
  return (
    <header className="h-16 bg-[var(--bg-panel)] border-b border-[var(--border-color)] flex items-center justify-between px-3 sm:px-6 z-30 sticky top-0 shadow-[4px_4px_10px_var(--shadow-dark),-4px_-4px_10px_var(--shadow-light)] transition-colors duration-300">
      ...
      {/* Center: Search input (Responsive flex width) */}
      ...
      <div className="flex items-center gap-1.5 sm:gap-3 shrink-0">
        ...
        <div 
          ...
          title="User Profile"
        >
          <div className="w-7 h-7 sm:w-8 sm:h-8 rounded-full bg-gradient-to-tr from-cyan-600 to-blue-500 text-white flex items-center justify-center text-xs font-bold shadow-[0_0_10px_rgba(6,182,212,0.4)] group-hover:scale-105 transition-transform">
            A
          </div>
