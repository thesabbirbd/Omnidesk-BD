...
export default function DevOpsTerminalModal() {
  ...
  useEffect(() => {
    ...
    ws.onerror = () => {
      ...
      term.write('\r\n\x1b[31m[WebSocket Connection Error: Check if Omnidesk BD backend is running.]\x1b[0m\r\n');
    };
  ...
  return (
    <div className="fixed inset-0 z-[120] flex items-center justify-center p-2 sm:p-6 bg-black/35 backdrop-blur-sm animate-fadeIn">
      <div 
        className={`w-full flex flex-col rounded-none sm:rounded-3xl bg-[var(--bg-card)] border border-[var(--border-color)] overflow-hidden transition-all duration-300 ${
