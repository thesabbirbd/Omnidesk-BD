...
<p align="center">
  ...
  <a href="#-100-offline-first--zero-paid-dependency-guarantee"><img src="https://img.shields.io/badge/Offline--First-100%25-10B981?style=for-the-badge&logo=shield&logoColor=white" alt="Offline-First"></a>
  <a href="https://opensource.org/licenses/MIT"><img src="https://img.shields.io/badge/License-MIT-F59E0B?style=for-the-badge" alt="License: MIT"></a>
</p>
...
<p align="center">
  <a href="https://github.com/thesabbirbd/Omnidesk-BD"><img src="https://img.shields.io/badge/⭐_Star_Repository-GitHub-181717?style=for-the-badge&logo=github&logoColor=white" alt="Star on GitHub"></a>
  <a href="http://localhost:5173"><img src="https://img.shields.io/badge/⚡_Launch_Web_UI-5173-646CFF?style=for-the-badge&logo=vite&logoColor=white" alt="Web UI"></a>
  <a href="http://localhost:8000/docs"><img src="https://img.shields.io/badge/📖_Swagger_API_Docs-8000-009688?style=for-the-badge&logo=fastapi&logoColor=white" alt="Swagger Docs"></a>
  <a href="https://github.com/thesabbirbd/Omnidesk-BD/issues"><img src="https://img.shields.io/badge/🐛_Report_Issue-Support-E11D48?style=for-the-badge&logo=github&logoColor=white" alt="Report Issue"></a>
</p>
...
```mermaid
graph TD
    Client["💻 Client (React 18 + Vite + Tailwind CSS v4)"]
    
    subgraph "Omnidesk BD API Gateway"
        AuthMiddleware["🛡️ UserIsolationMiddleware & Tenancy Guard"]
        APIRouters["🌐 REST Endpoints (/api/v1)"]
        WSLab["🔌 WebSocket PTY Bridge (DevOps Terminal)"]
    end

    subgraph "Core Engines & Processing"
        Ingestion["📥 Ingestion Engine (PyMuPDF, Markdown, TXT, YouTube)"]
        AIService["🧠 AI Cascade (Gemini Free → Ollama Local → Offline Heuristic)"]
        Scheduler["⏱️ Time-Aware Scheduler (Topological DAG & Breaks)"]
        Templates["📦 Template Registry (Instant Offline Curricula)"]
    end

    subgraph "Persistent Storage"
        Postgres[("🐘 PostgreSQL 16 (Relational DAG & Provenance)")]
        Redis[("⚡ Redis 7 (Cache, Sessions & Task Broker)")]
        FileVault[("📂 Storage Vault (Uploaded Documents)")]
    end

    Client <-->|HTTP / JSON| AuthMiddleware
    Client <-->|WebSocket| WSLab
    AuthMiddleware --> APIRouters
    APIRouters --> Ingestion
    APIRouters --> AIService
    APIRouters --> Scheduler
    APIRouters --> Templates
    APIRouters --> Postgres
    APIRouters --> Redis
    Ingestion --> FileVault
```
